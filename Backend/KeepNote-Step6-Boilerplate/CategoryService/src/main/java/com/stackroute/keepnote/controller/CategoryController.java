...
public class CategoryController {
	...
	public ResponseEntity<?> getCategoryByUserId(@PathVariable String id) {
				List<Category> categoryById;
				try {
					categoryById = categoryService.getAllCategoryByUserId(id);
					///if(categoryById!=null) {
						return new ResponseEntity<>(categoryById, HttpStatus.OK);
				/*	}else {
						return new ResponseEntity<>("No category found for this userid found", HttpStatus.NOT_FOUND);
					} */
				} catch (Exception e) {
